...
class SPTest {
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a single value parameter.
   */
  @Test
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a Map parameter.
   */
  @Test
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a single value parameter. This test shows using annotations for stored procedures
   */
  @Test
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a single value parameter. This test shows using annotations for stored procedures and using a
   * resultMap in XML
   */
  @Test
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a Map parameter. This test shows using annotations for stored procedures
   */
  @Test
  ...
  /*
   * This test shows how to use an input and output parameters and return a result set from a stored procedure. This
   * test shows using a Map parameter. This test shows using annotations for stored procedures and using a resultMap in
   * XML
   */
  @Test
